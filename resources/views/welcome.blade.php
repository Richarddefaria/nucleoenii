    ...
    <div class="p-10 color1">
        <div class="border-color2 border-radius color4">
            ...
            <div class="mx-10 mt-10 mb-4">
                <form action="{{ route('impacto', $project->id)}}" method="POST" class="grid grid-cols-12 grid-rows-12 md:text-xl lg:text-2xl lg:gap-5 max-lg:pb-5 lg:py-10">
                    @csrf
                    ...
                    <a href="#" class="col-span-2 max-md:col-start-5 md:col-start-6 ml-7 mt-5"><button class="button"
