    ...
    <div class="p-10 color1">
        <div class="border-color2 border-radius color4">
            <div class="customtitle2 max-lg:text-3xl text-center color3 text-white custom-mt">
                <h2 class="m-0 custom-bordercolor2 font-bold">Modificar Impacto</h2>
            </div>
            <div class="mx-10 mt-10 mb-4">
                <form action="{{ route('impacto.update', [$project->id, $impacto->id]) }}" method="POST" class="grid grid-cols-12 grid-rows-12 md:text-xl lg:text-2xl lg:gap-5 max-lg:pb-5 lg:py-10">
                    @csrf
                    @method('PUT')
