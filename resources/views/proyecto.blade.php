            ...
            <div class="max-md:mx-6 max-lg:mx-12 mx-10 mt-10 mb-4">
                <form action="{{ route ('proyecto')}}" method="POST"
                    ...
                    <div
                        ...
                        <input type="text" name="area" class="w-full py-1.5 px-3" id="area">
                        @error('area')
                        <small class="text-red-600"> {{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            <div id="preview-container" class="mr-5"></div>
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="imagen1" class="cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-paperclip inline max-lg:w-7" width="44"
                                    height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FE8101" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="imagen2" class="cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-paperclip inline max-lg:w-7" width="44"
                                    height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FE8101" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <div class="flex items-center">
                            <div id="preview-container4" class="mt-5 mr-5"></div>
                            <label for="imagen3" class="cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-paperclip inline max-lg:w-7" width="44"
                                    height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FE8101" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <div
                        class="max-md:col-span-12 md:col-span-5 lg:col-span-5 xl:col-span-3 max-md:row-start-16 row-start-12 mt-2">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="icon icon-tabler icon-tabler-id inline max-lg:w-7" width="44" height="44"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="#FE8101" fill="none" stroke-linecap="round"
                            stroke-linejoin="round">
                        ...
                        <label for="dni" class="">Cédula del integrante:</label>
                    </div>
                    <div id="form"
                        class="max-md:col-span-7 md:col-span-3 max-md:row-start-17 lg:col-span-3 row-start-12">
                        <div class="input-container">
                            <div class="input-row flex gap-5">
                                <input type="text" name="cedula[]" class="w-full py-1.5 px-3 mb-3 inline mt-2" id="dni">
                                <button class="button">Cargar</button>
                                <button
                                    class="button-remove button xl:bg-red-500 xl:hidden text-xl text-white px-5 px rounded-md">Quitar</button>
                            </div>
                        </div>
                    </div>
                    <div id="input-container" class="hidden col-span-5">
                        <div class="input-row flex gap-5">
                            <input type="text" name="cedula[]" class="w-full py-1.5 px-3 mb-3 inline mt-2" id="dni">
                            <button class="button">Cargar</button>
                        </div>
                    ...
                    <div class="row-start-12">
                        <svg id="add-input" xmlns="http://www.w3.org/2000/svg"
                            class="icon icon-tabler icon-tabler-circle-plus ml-3 cursor-pointer inline mt-2" width="44"
                            height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FE8101" fill="none"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <p
                        class="max-md:col-span-12  md:col-span-9 lg:col-span-5 max-lg:indent-8 indent-12 max-lg:mt-5 lg:mt-10 font-bold underline max-md:row-start-18 row-start-14">
                        Redes Sociales del proyecto:</p>
                    <div
                        class="max-md:col-span-12 md:col-span-3 lg:col-span-3 xl:col-span-2 max-md:row-start-19 row-start-15">
                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="max-md:col-span-12  md:col-span-7 lg:col-span-4 max-md:row-start-20 row-start-15">
                        <input type="text" name="facebook" class="w-full py-1.5 px-3" id="facebook">
                    </div>
                    <div
                        class="max-md:col-span-12 md:col-span-3 lg:col-span-3 xl:col-span-2 max-md:row-start-21 row-start-16">
                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="max-md:col-span-12  md:col-span-7 lg:col-span-4 max-md:row-start-22 row-start-16">
                        <input type="text" name="instagram" class="w-full py-1.5 px-3" id="instagram">
                    </div>
                    <div
                        class="max-md:col-span-12 md:col-span-3 lg:col-span-3 xl:col-span-2 max-md:row-start-23 row-start-17">
                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="max-md:col-span-12  md:col-span-7 lg:col-span-4 max-md:row-start-24 row-start-17">
                        <input type="text" name="linkedin" class="w-full py-1.5 px-3" id="linkedin">
                    </div>
                    <div
                        class="max-md:col-span-12 md:col-span-3 lg:col-span-3 xl:col-span-2 max-md:row-start-25 row-start-18">
                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="max-md:col-span-12  md:col-span-7 lg:col-span-4 max-md:row-start-26 row-start-18">
                        <input type="text" name="tiktok" class="w-full py-1.5 px-3" id="tiktok">
                    </div>
                    <div
                        class="max-md:col-span-12 md:col-span-3 lg:col-span-3 xl:col-span-2 max-md:row-start-27 row-start-19">
                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="max-md:col-span-12  md:col-span-7 lg:col-span-4 max-md:row-start-28 row-start-19">
                        <input type="text" name="twitch" class="w-full py-1.5 px-3" id="twitch">
                    </div>
                    <div
                        class="max-md:col-span-12 md:col-span-3 lg:col-span-3 xl:col-span-2 max-md:row-start-29 row-start-20">
                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="max-md:col-span-12  md:col-span-7 lg:col-span-4 max-md:row-start-30 row-start-20">
                        <input type name="twitter" class="w-full py-1.5 px-3" id="twitter">
                    </div>
                    <div
                        class="max-md:col-span-12 md:col-span-3 lg:col-span-3 xl:col-span-2 max-md:row-start-31 row-start-21">
                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="max-md:col-span-12  md:col-span-7 lg:col-span-4 max-md:row-start-32 row-start-21">
                        <input type="text" name="youtube" class="w-full py-1.5 px-3" id="youtube">
                    </div>
                    <button
                        class="button max-md:col-start-4 max-md:col-span-6 md:col-span-4 md:col-start-5 lg:col-span-3 lg:col-start-6 xl:col-span-2 xl:col-start-6 max-md:row-start-33 row-start-22 mt-5"
